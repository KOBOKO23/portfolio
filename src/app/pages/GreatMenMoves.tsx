...
import { Users, Target, Heart, Award, TrendingUp, BookOpen, Compass, Lightbulb, Shield, Calendar, UserPlus, DollarSign, CheckCircle } from 'lucide-react';
  ...
  const impactGoals = [
    {
      icon: Users,
      number: '500',
      label: 'Young Men Mentored by 2027',
      progress: 10,
    },
    {
      icon: BookOpen,
  ...
  const values = [
    {
      ...
      description: 'Building integrity, honesty, and moral foundations that last a lifetime.',
    },
    {
      icon: Lightbulb,
      title: 'Boundless Thinking',
      description: 'Teaching boys to think beyond limitations and embrace impossible dreams.',
    },
    {
      icon: Shield,
      title: 'Faith & Discipline',
      description: 'Grounding young men in spiritual values and self-discipline.',
    },
    {
      icon: Compass,
      title: 'Purpose-Driven',
      description: 'Helping every boy discover and pursue his unique calling.',
    },
  ];
  ...
  const howToHelp = [
    {
      ...
      description: 'Share your experience and guide a young man toward his potential.',
      action: 'Volunteer',
      icon: UserPlus,
    },
    {
      title: 'Make a Donation',
      description: 'Support our programs and help us reach more young men.',
      action: 'Donate Now',
      icon: DollarSign,
    },
    {
      title: 'Partner With Us',
      description: 'Organizations and businesses can sponsor programs and events.',
      action: 'Contact Us',
      icon: Users,
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-32 lg:py-48 px-6 lg:px-12 bg-black text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1744809448493-448812255e4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwYm95cyUyMGVkdWNhdGlvbiUyMHNtaWxpbmd8ZW58MXx8fHwxNzcyMjc4NTY3fDA&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Great Men Moves"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            ...
            >
              <div className="aspect-[3/4] overflow-hidden">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1627406514740-ba770793c260?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBZnJpY2FuJTIwbWFuJTIwY29udGVtcGxhdGl2ZSUyMHBvcnRyYWl0fGVufDF8fHx8MTc3MjI3ODIxNXww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Koboko - Founder"
            ...
            >
              ...
              <div className="space-y-6 text-lg text-black/70 leading-relaxed">
                <p>
                  Growing up, I witnessed countless young boys with limitless potential lose their way due to lack of guidance, mentorship, and belief. I saw brilliance dimmed by circumstance, dreams deferred by discouragement, and futures compromised by the absence of strong male role models.
                </p>
                <p>
                  Great Men Moves was born from a deep conviction: <strong className="text-black">every boy deserves to be seen, heard, and believed in.</strong> As someone who has walked the journey from meteorology to software development, from music to mentorship, I understand the power of having someone who pushes you to think beyond your current reality.
                </p>
                <p>
                  This initiative is my commitment to being that person for young men who need it most. Together, we are building a movement of boys who refuse to accept impossibility, who lead with character, and who will transform Africa one decision at a time.
                </p>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <p className="text-xl text-black/70 max-w-3xl mx-auto">
              We're building towards measurable, meaningful impact in the lives of young men across Kenya and beyond.
            </p>
          </motion.div>
      ...
      <section id="volunteer" className="py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            {[
              'Flexible commitment (2-4 hours/month)',
        ...
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl leading-relaxed mb-12 max-w-3xl mx-auto">
              Your donation provides mentorship, resources, and opportunities for young men who will lead the next generation. Every contribution creates ripples of change.
            </p>
